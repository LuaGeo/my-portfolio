...
const TECH = [
  ...
  { id: 'js',         name: 'JavaScript',     src: 'assets/tech/javascript.png',  cat: 'web' },
  { id: 'ts',         name: 'TypeScript',     src: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/typescript/typescript-original.svg', cat: 'web' },
...
const PROJECTS = [
  {
    ...
    links: [
      { kind: 'demo',   url: 'https://comparateur-de-pdf.streamlit.app',                label: { fr: 'Démo Streamlit', en: 'Streamlit demo', pt: 'Demo Streamlit' } },
      { kind: 'github', url: 'https://github.com/LuaGeo/final_comparator_app',          label: { fr: 'GitHub (Streamlit)', en: 'GitHub (Streamlit)', pt: 'GitHub (Streamlit)' } },
      { kind: 'github', url: 'https://github.com/LuaGeo/docs-comparator-next',          label: { fr: 'GitHub (Next.js)',   en: 'GitHub (Next.js)',   pt: 'GitHub (Next.js)' } },
    ],
  },
  {
    id: 'guessmymeal',
    ...
    subtitle: {
      fr: 'Mobile / Computer Vision / Machine Learning',
      en: 'Mobile / Computer Vision / Machine Learning',
      pt: 'Mobile / Computer Vision / Machine Learning',
    },
    problem: {
    ...
    links: [
      { kind: 'github', url: 'https://github.com/LuaGeo/guessmymealMobile', label: { fr: 'Dépôt GitHub', en: 'GitHub repo', pt: 'Repo GitHub' } },
    ],
  },
  {
    id: 'wlab',
    ...
    links: [
      { kind: 'demo',   url: 'https://wlab-breast-cancer.streamlit.app',         label: { fr: 'Démo Streamlit', en: 'Streamlit demo', pt: 'Demo Streamlit' } },
      { kind: 'github', url: 'https://github.com/LuaGeo/wlab-breast-cancer',     label: { fr: 'Dépôt GitHub',   en: 'GitHub repo',     pt: 'Repo GitHub' } },
    ],
  },
  {
    id: 'job',
    ...
    links: [
      { kind: 'demo',   url: 'https://hackathon-salary-prediction.streamlit.app',                    label: { fr: 'Page Streamlit', en: 'Streamlit page',  pt: 'Página Streamlit' } },
      { kind: 'github', url: 'https://github.com/LuaGeo/salary_prediction_ML_project/tree/main',     label: { fr: 'Dépôt GitHub',   en: 'GitHub repo',     pt: 'Repo GitHub' } },
    ],
  },
  {
    id: 'cine',
    ...
    links: [
      { kind: 'demo',   url: 'https://ml-cine-creuse-frontend.vercel.app/',           label: { fr: 'Démo Vercel',     en: 'Vercel demo',     pt: 'Demo Vercel' } },
      { kind: 'github', url: 'https://github.com/LuaGeo/ml_cine-creuse-backend',      label: { fr: 'GitHub Backend',  en: 'GitHub Backend',  pt: 'GitHub Backend' } },
      { kind: 'github', url: 'https://github.com/LuaGeo/ml_cine-creuse-frontend',     label: { fr: 'GitHub Frontend', en: 'GitHub Frontend', pt: 'GitHub Frontend' } },
      { kind: 'docs',   url: 'https://www.canva.com/design/DAGKW0a6nM8/AWeq8DHFtrKhasG19fB8rA/view', label: { fr: 'Présentation', en: 'Slides', pt: 'Apresentação' } },
    ],
  },
  {
    id: 'kley',
    ...
    tags: ['Data', 'Dataviz'],
    title: { fr: 'Kley Résidences', en: 'Kley Residences', pt: 'Kley Residências' },
    subtitle: {
    ...
    links: [
      { kind: 'demo',   url: 'https://public.tableau.com/views/Kley_Residences/Tableaudebord1', label: { fr: 'Tableau Public', en: 'Tableau Public', pt: 'Tableau Public' } },
    ],
  },
  {
    id: 'toys',
    ...
    stackExtra: [],
    links: [
      { kind: 'docs', url: 'https://www.canva.com/design/DAGKb9BGl3U/-B_gaB8_1Z6IFYqYbdG8WQ/view', label: { fr: 'Présentation', en: 'Slides', pt: 'Apresentação' } },
    ],
  },
];
